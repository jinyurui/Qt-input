...
GooglePinyin::GooglePinyin()
{
    ...
    QSettings setter("D:/QtPlug/Qt5Inputplugin/dict/pinyinEx.ini", QSettings::IniFormat);
    ...
    bool ret = im_open_decoder("D:/QtPlug/Qt5Inputplugin/dict/dict_pinyin.dat", "D:/QtPlug/Qt5Inputplugin/dict/user.dat");
    if (!ret)
    {
        qDebug() << "open dict faild";
        return;
    }
    im_init_user_dictionary("D:/QtPlug/Qt5Inputplugin/dict/user.dat");
}
